...
// Must define globally so we can use in other views
let BACKGROUND_COLOR = UIColor.init(red:0.269, green:0.000, blue:0.000,
                                    alpha:1.00) // Weird blue
let FOREGROUND_COLOR = UIColor.init(red: 0.431, green: 0.850,
                                    blue: 1.000, alpha: 1.0)  // Tannish
